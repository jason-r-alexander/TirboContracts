...
<hr class="featurette-divider-top">
	...
	<div class="container">
<form action='team.php' method='post' class="form-login"/>
    <h2 class="form-contract-c">Team Information</h2>

    <input type="text" name="T_SPORT" class="form-control" placeholder="Sport">
    <input type="text" name="T_GENDER" class="form-control" placeholder="Gender">
    <input type="text" name="T_DIVISION" class="form-control" placeholder="Division">
