...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!--nav bar start --> 
        ...
        <!-- /.container -->
    </nav><body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
...
<!--<form action='contract.php' method='GET' class="form-contract-create"/>-->
<form method='GET' class="form-contract-create"/>
...
$result = $con->query("SELECT UNI_ID, UNI_NAME FROM University");
    ...
    echo '<option value="'.$AT_ID.'">'.$AT.'</option>';
...
//echo $HT;
  ...
  $result = $con->query("SELECT UNI_ID, UNI_NAME FROM University");
    ...
    echo '<option value="'.$HT_ID.'">'.$HT.'</option>';
  ...
  <div class="col-md-10">
      ...
      $id=$_GET['id'];
        ...
        $C_DATE = $row['C_DATE'];
          ...
          echo '<input name="Date" class="form-control" type="date" name="Date" value="'.$C_DATE.'"required autofocus/>';
          ?>
  ...
  <div class="col-md-10">
      ...
      $id=$_GET['id'];
        ...
        $C_START_TIME = $row['C_START_TIME'];
          ...
          echo '<input name="StartTime" class="form-control" type="time" name="Time" value="'.$C_START_TIME.'" required autofocus/>';
          ?>
  </div>
</div>
  ...
  <div class="col-md-10">
      ...
      $id=$_GET['id'];
        ...
        $C_END_TIME = $row['C_END_TIME'];
          ...
          echo '<input name="StartTime" class="form-control" type="time" name="Time" value="'.$C_END_TIME.'" required autofocus/>';
          ?>
  </div>
</div>
  ...
  <div class="col-md-10">
      ...
      $id=$_GET['id'];
        ...
        $C_RULES = $row['C_RULES'];
          ...
          echo '<select name="Rule" class="form-control" required autofocus/>
          <option>'.$C_RULES.'</option>
          <option>NCAA</option>
          <option>ITA</option>
      </select>';
          ?>
      ...
      <p align="left">
        <?php
          ...
          //echo $HT;
            ...
            echo '<text class="form-control" id="AwayTeamValue">'.$AT.'</text>';
      ...
      <p align="left">
        <?php
          ...
          //echo $HT;
            ...
            echo '<text class="form-control" id="HomeTeamValue">'.$HT.'</text>';
     ...
     <?php 
      $id=$_GET['id'];
        ...
        $C_SIGNED_A_DATE = $row['C_SIGNED_A_DATE'];
          ...
          echo '<text id="SignDate_A" class="form-control">'.$C_SIGNED_A_DATE.'</text>';
          ?>
    </p>
  </div>
    ...
    <p align="center"><b>DATE</b>
      ...
      $id=$_GET['id'];
        ...
        $C_SIGNED_H_DATE = $row['C_SIGNED_H_DATE'];
          ...
          echo '<text id="SignDate_H" class="form-control">'.$C_SIGNED_H_DATE.'</text>';
          ?>
    </p>
  </div>
</div>
